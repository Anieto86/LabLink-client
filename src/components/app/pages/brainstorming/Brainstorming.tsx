...
import Canvas from '@/components/app/pages/brainstorming/canvas/Canvas';
import TextNode from '@/components/app/pages/brainstorming/nodes/TextNode';
...
const Brainstorming: React.FC = () => {
  return (
    <div style={{ position: 'relative', width: '100vw', height: '100vh' }}>
      {/* Render the PIXI canvas (which shows the grid and handles panning/zooming) */}
      <Canvas />
      {/* Render the interactive ellipsis node */}
      {/* <TextNode /> */}
      <FloatingMenu />
    </div>
  );
